...
const Footer: React.FC = () => {
  return (
    <footer className="bg-primary w-full mt-20">
      <div className="max-w-1440px mx-auto px-8 md:px-16 py-16 border-t border-white/5 font-sans text-sm leading-relaxed text-gray-300">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="flex gap-6 mb-6">
              ...
              <a href="#" className="group">
                <div className="p-3 rounded-full bg-white/5 group-hover:bg-primary-esmeralda/20 transition-all border border-white/10 group-hover:border-primary-esmeralda/50">
                  <svg className="w-5 h-5 fill-gray-400 group-hover:fill-emerald-400 transition-colors" viewBox="0 0 24 24">
